...
from buffet_indicator import get_buffet_indicator_norm
from ibov_usd import get_ibovusd, _get_trend_line

if __name__ == '__main__':
    ibovusd = get_ibovusd()
    ibovusd_middle_trend_line = _get_trend_line(ibovusd, _type='middle')
    ...
    color = 'tab:green'
    text = 'IBOVESPA USD / middle trend line'
    ax1.plot(ibovusd.index, ibovusd / ibovusd_middle_trend_line, color=color, label=text)
